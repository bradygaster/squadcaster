    ...
    function onboardingSnapshot() {
      ...
      const steps = [
        ...
        },
        {
          ...
          description: "Pull request 1 of 2 · add all six Squad source/lock workflow pairs."
        },
        {
          ...
          \${!hasProposal ? \`
            ...
            <div class="layout">
              <section>
                ...
                \${confirmSetup ? \`
                  <div class="confirmation">
                    <p><strong>Create onboarding pull request 1 of 2?</strong><br>This first PR installs gh-aw and all six supported Squad workflows. The slash commands remain inactive until you merge it. Squadcaster then enables the cast issue, and Squad opens a separate PR containing the approved team. Neither PR is merged automatically.</p>
                    <div class="actions">
                      <button class="button" data-action="cancel-confirm" type="button">Cancel</button>
